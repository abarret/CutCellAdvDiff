...
main(int argc, char* argv[])
{
    ...
    bool output_new_bdry_data = input_db->getBool("OUTPUT_BDRY_DATA");
         ...
         coarse_iteration_num += coarse_hier_dump_interval, fine_iteration_num += fine_hier_dump_interval)
    {
...

        {
            ...
            Pointer<LSFromLevelSet> vol_in_fcn = new LSFromLevelSet("VolFcn", fine_patch_hierarchy);
            Pointer<LSFromLevelSet> vol_out_fcn = new LSFromLevelSet("VolFcn", fine_patch_hierarchy);
            vol_in_fcn->registerLSFcn(ls_in_fcn);
            vol_out_fcn->registerLSFcn(ls_out_fcn);
...

        {
            ...
            Pointer<LSFromLevelSet> vol_in_fcn = new LSFromLevelSet("VolFcn", coarsened_fine_patch_hierarchy);
            Pointer<LSFromLevelSet> vol_out_fcn = new LSFromLevelSet("VolFcn", coarsened_fine_patch_hierarchy);
            vol_in_fcn->registerLSFcn(ls_in_fcn);
            vol_out_fcn->registerLSFcn(ls_out_fcn);
